...
//            _systemRootPath = env.WebRootPath;
//            _systemRootPath = Path.GetFullPath(Path.Combine(env.WebRootPath, @"../../"));
//            _tempPath = _systemRootPath + "\\webapp\\wwwroot\\myassets\\Temp";
//            _filesRootPath = _systemRootPath + "/webapp/wwwroot/myassets/uploads";
//            _filesRootVirtual = _systemRootPath + "/webapp/wwwroot/myassets/uploads";
...
//        {
//            //_settings = JsonConvert.DeserializeObject<Dictionary<string, string>>(System.IO.File.ReadAllText("D:\\SideProj\\MyAppSln\\WebApp" + "/wwwroot/lib/fileman/conf.json"));
//            _settings = JsonConvert.DeserializeObject<Dictionary<string, string>>(System.IO.File.ReadAllText(_systemRootPath + "/webapp/wwwroot/lib/fileman/conf.json"));
//            string langFile = _systemRootPath + "/webapp/wwwroot/lib/fileman/lang/" + GetSetting("LANG") + ".json";
//            if (!System.IO.File.Exists(langFile)) langFile = _systemRootPath + "/webapp/wwwroot/lib/fileman/lang/en.json";
