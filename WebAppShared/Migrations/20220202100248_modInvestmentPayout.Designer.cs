...
namespace WebAppShared.Migrations
{
    ...
    [Migration("20220202100248_modInvestmentPayout")]
    partial class modInvestmentPayout
    {
            ...
            modelBuilder.Entity("WebAppShared.ModelsApi.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2022, 2, 2, 13, 2, 47, 916, DateTimeKind.Local).AddTicks(8859),
